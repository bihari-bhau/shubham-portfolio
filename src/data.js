...
export const PROJECTS = [
  ...
  title: 'TaskFlow',
  period: '2025 – Present',
  desc: 'A production-ready full-stack team task management platform combining Kanban workflows, analytics dashboards, attendance tracking, and role-based access control. Features JWT auth, RBAC (Admin/Member), 6-stat analytics with Recharts, cross-project task tracker, daily check-in/checkout system, and WebSocket-based chat (in progress). Seeded with 23 demo users across 5 projects. Deployed via Docker + Nginx on Railway with runtime API URL injection.',
  ...
  title: 'CodeRAG',
  period: '2025 – Present',
  desc: 'A full-stack RAG application that lets you index any public GitHub repository and chat with it. Paste a repo URL, trigger embedding via OpenAI text-embedding-3-small, and ask questions about architecture, code logic, or bugs. Uses ChromaDB as a persistent vector store with configurable chunking and top-k retrieval. LLM is swappable — defaults to GPT-4o-mini. Fully containerised with Docker Compose.',
  stack: ['React', 'TypeScript', 'Vite', 'FastAPI', 'ChromaDB', 'OpenAI', 'Docker'],
  github: 'https://github.com/bihari-bhau/codebase-rag',
  live: null,
  isLive: false,
  },
  {
